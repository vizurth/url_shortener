...
internal/
  ...
  service/           — бизнес-логика: генерация кода, нормализация URL
  storage/
    postgres/        — реализация на PostgreSQL
    memory/          — реализация в памяти (sync.RWMutex)
pkg/
  postgres/          — пул соединений, миграции
  logger/            — zap-based context logger
